...
<h1>添加新闻：</h1>
<form class="form-horizontal" action="${APP_PATH}/saveNews" method="post">
    <div class="form-group">
        <label class="col-sm-2 control-label">新闻标题:</label>
        <div class="col-sm-10">
            <input type="text" name="title" class="form-control" id="newstitle_add_input">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea type="text" name="content" id="content"></textarea></p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            ...
            <div class='input-group date' id='datetimepicker'>
                <input type='text' class="form-control" name="issuetime"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="froms" class="form-control" id="froms">
        </div>
    </div>
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                $.each(result.extend.categories,function(){
                    ...
                    optionEle.appendTo("#category_add_select");
                });
            }
        });
